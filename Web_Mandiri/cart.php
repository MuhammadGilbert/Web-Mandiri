...
if (isset($_GET['kode_produk']) && isset($_GET['jumlah'])) {
    ...
    $jumlah=$_GET['jumlah'];
    include 'koneksi.php';
    $sql= "select * from tblproduct where kode_produk='$kode_produk'";
        ...
        ?>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="shop.php?halaman=keranjang-belanja&kode_produk=<?php echo $item['kode_produk']; ?>&aksi=hapus" class="btn btn-danger btn-xs" role="button">Delete</a>
                </td>
            </tr>
        <?php 
            endforeach;
